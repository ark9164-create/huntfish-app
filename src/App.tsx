...
import { Search, MapPin, Star, Calendar, Heart, X, Clock, ChevronRight, Bookmark, ArrowRight, Check, User, Award, Eye, ChevronDown, Shield, Sun } from 'lucide-react';
import {
  FISH_THEME, HUNT_THEME, FISH_LOCATIONS, HUNT_LOCATIONS,
  SEASONS, EXP_LEVELS, GUIDES, SPECIES,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: compact ? 1 : 2 }}>
        ...
        {cells.map((d, i) => {
          ...
          <div
            ...
            onClick={() => { if (d?.avail && onSelectDate) onSelectDate(d.dateStr); }}
            style={{
            ...
            <div style={{padding:'18px 22px 22px'}}>
              ...
              <div style={{marginBottom:18}}>
                ...
                <div style={{display:'flex',alignItems:'center',gap:12,marginTop:8,fontSize:10,color:'#9ca3af'}}>
                  ...
                  <span style={{marginLeft:'auto',fontStyle:'italic'}}>Click a date to select</span>
                </div>
